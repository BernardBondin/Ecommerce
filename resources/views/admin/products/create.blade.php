            ...
            @endif
                ...
                <form action="{{ url('admin/products/') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="colour-tab" data-bs-toggle="tab" data-bs-target="#colour-tab-pane" type="button" role="tab" aria-controls="colour-tab-pane" aria-selected="false">Product Colour</button>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade border p-3 show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="small_description" class="form-control mt-1" rows="4"></textarea>
                            </div>

                            <div class="mb-3">
                                <label>Description</label>
                                <textarea name="description" class="form-control mt-1" rows="4"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade border p-3" id="seotag-tab-pane" role="tabpanel" aria-labelledby="seotag-tab" tabindex="0">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="meta_keyword" class="form-control mt-1" rows="4"></textarea>
                            </div>
                            <div class="mb-3">
                                <label>Meta Description</label>
                                <textarea name="meta_description" class="form-control mt-1" rows="4"></textarea>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="original_price" class="form-control mt-1">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label>Selling Price</label>
                                        <input type="number" name="selling_price" class="form-control mt-1">
                                    </div>
                                </div><div class="col-md-4">
                                    <div class="mb-3">
                                        <label>Quantity</label>
                                        <input type="number" name="quantity" class="form-control mt-1">
                                    </div>
                                </div><div class="col-md-4">
                                    <div class="mb-3">
                        ...
                        <div class="tab-pane fade border p-3" id="colour-tab-pane" role="tabpanel" aria-labelledby="colour-tab" tabindex="0">
                            <div class="mb-3">
                        ...
                        <div>
                            <button type="submit" class="btn float-end btn-success">Save</button>
                        </div>
                </form>
